...
The reality is that **the code was never the hard part**. Within a few weeks you can teach an 11-year old to write working code.  By the second month, most interns can start building features on a mid-sized project. From there it's several (many?) years of hard work to achieve a degree of mastery. What happens in those years?
