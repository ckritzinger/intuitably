...
Small, free, single-page games built to help my kids (and now some of their friends) practice a specific school skill. No accounts, no backend, no ads. Everything runs client-side and lives in your browser's `localStorage`. They're all built with the same lightweight stack (Vue 3, Vite, GitHub Pages) so I can knock out a new one fast whenever I get an idea or request.
...
[Play](https://ckritzinger.github.io/x-blitz/) · [https://github.com/ckritzinger/x-blitz](https://github.com/ckritzinger/x-blitz)
...
[Play](https://ckritzinger.github.io/wordie/) · [https://github.com/ckritzinger/wordie](https://github.com/ckritzinger/wordie)
...
[Play](https://ckritzinger.github.io/word-spotter/) · [https://github.com/ckritzinger/word-spotter](https://github.com/ckritzinger/word-spotter)
